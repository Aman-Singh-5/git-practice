const Footer = () => {
    ...
    <div class="main-footer">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6 left_portion">
                    <div class="single-widget pr-60">
                        <div class="footer-logo pb-25">
                            <a href="index.html"><img src={"images/footer-logo.webp"} alt="eduhome"/></a>
                        </div>
                ...
                <div class="col-lg-2 col-md-6 pt-4 pt-lg-0 left_portion ">
                    <div class="single-widget">
                        <h3>useful links</h3>
                        <ul>
    ...
    <div class="footer-bottom text-center">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <p>Copyright © <a href="index.html">Eduhome</a> 2022. All Right Reserved By <a href="https://themeforest.net/user/hastech/portfolio" target="_blank">Hastech.</a></p>
                </div> 
            </div>
        </div>    
    </div>
